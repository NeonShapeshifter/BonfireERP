  ...
  <aside className="w-64 hidden sm:block border-r border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-4">
    <div className="flex items-center mb-8 gap-2">
      <img
        ...
        className="w-8 h-8"
      />
      <span className="text-xl font-bold">Bonfire ERP</span>
    </div>
...
const SidebarButton: React.FC<SidebarButtonProps> = ({ label, icon: Icon, active, onClick }) => (
  <button
    ...
    className={clsx(
      ...
      active ? 'bg-accent text-white' : 'text-gray-700 dark:text-gray-300 hover:bg-neutral-100 dark:hover:bg-neutral-700'
    )}
  >
